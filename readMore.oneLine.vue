<template>
  <div class="wrapper">
    <v-read-more-box max-height="36" read-more="Show More!" read-less="Show Less!" horizontal>
      <template slot="readMore">
        <div class="horizontalControl readMore">&hellip; [Read More]</div>
      </template>
      <template slot="readLess">
        <div class="horizontalControl readMore">[Read Less]</div>
      </template>
      ...
      <p>
        ...
        <a
          href="#"
        >Donec non enim</a> in turpis pulvinar facilisis. Ut felis.Aenean fermentum, elit eget tincidunt condimentum, eros ipsum
